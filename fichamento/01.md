...
Eles usam a AADL para uma abordagem baseada em modelos para separar e aprimorar o desenvolvimento, dividindo as funções de engenheiros de software e especilistas em robótica.
...
A proposta é criar uma descrição de uma arquitetura de robô baseada em modelos e usar isso para analise de arquiterura, com AADL, e geração de código automática, usando o ROS.
